<footer>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjz6eJHmjVFuC-W5B5IhuWj4i9hE0aHJs"></script>
        <script src="../js/map.js" onload="initMap(-2.8869194, -78.9914455, 18)"></script>
